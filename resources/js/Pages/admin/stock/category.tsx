...
export default function AddStockCategoryDashboard({
    appName,
    appTitle,
    nameUser,
    roleUser,
    ...
    const { setData, reset, errors, processing, post } = useForm({
        name: "",
        tags: "",
    });
    ...
    const submit = (e: any) => {
        e.preventDefault();
        post(route("stock.add.category.store"), {
    ...
    return (
        <AdminLayout
            ...
            breadcumb1={"Aplikasi"}
            breadcumb2={"Stok"}
            breadcumb3={"Tambah Kategori"}
            breadcumb2Href={route("stock.show")}
        >
            <Head title={"Tambah Kategori - Stok"} />
